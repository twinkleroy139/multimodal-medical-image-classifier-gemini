...
<p class="subtitle">Upload cross-sectional CT scan slice images (.jpg, .png) for detailed anatomical assessment.</p>

<form id="upload-form" enctype="multipart/form-data">
    <input type="hidden" name="modality" value="ct">
    
    <div class="upload-container" id="drop-zone">
        <div class="upload-icon">🔬</div>
        <p><strong>Drag & drop your CT scan here</strong>, or <span class="browse-link">browse files</span></p>
    ...
    <div id="preview-container" class="hidden">
        <div class="viewport-wrapper">
            <img id="image-preview" src="#" alt="CT Preview">
        ...
        <div class="preview-actions">
            <button type="submit" class="btn" id="analyze-btn">Analyze CT Report</button>
