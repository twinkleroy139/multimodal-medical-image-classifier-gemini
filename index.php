...
<h2>X-Ray Scan Analysis</h2>
<p class="subtitle">Upload or capture a standard X-Ray image (.jpg, .png) for comprehensive diagnostic classification.</p>

<form id="upload-form" enctype="multipart/form-data">
    <input type="hidden" name="modality" value="xray">
    
    <div class="upload-container" id="drop-zone">
        <div class="upload-icon">📁</div>
        <p><strong>Drag & drop your X-Ray here</strong>, or <span class="browse-link">browse files</span></p>
    ...
    <div id="preview-container" class="hidden">
        <div class="viewport-wrapper">
            <img id="image-preview" src="#" alt="X-Ray Preview">
        ...
        <div class="preview-actions">
            <button type="submit" class="btn" id="analyze-btn">Analyze X-Ray Report</button>
